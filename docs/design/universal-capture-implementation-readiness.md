...
2. Support title, note/instructions, capture type mapped to existing Work Item
   ...
   source link.
3. Start from global shell plus one or two high-value contexts such as Customer
