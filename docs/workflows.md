...
- Estimate handoff Work Items do not create estimates, send estimates, mutate opportunity/project readiness, create commission/payroll obligations, or replace canonical estimate status. Commission ownership remains planned metadata until a dedicated approved commercial/financial slice adds auditable canonical owner fields and downstream calculation policy.
