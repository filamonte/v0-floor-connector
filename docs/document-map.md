...
| [docs/product-operating-model.md](C:/FloorConnector/docs/product-operating-model.md)                       | Target product operating model, pre-sale/sold-work boundary, readiness, and AIA posture.        | Product governance    | Product Council + Architecture Coordination | Quarterly or after product operating-model decisions. |
| [docs/design-system-governance.md](C:/FloorConnector/docs/design-system-governance.md)                     | UX governance, page type responsibilities, dashboard/workspace boundaries, and color semantics. | UX governance         | UX Architecture + Architecture Coordination | Quarterly or before UX governance waves.              |
