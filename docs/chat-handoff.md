...
- Portal-bound auth redirects intentionally skip contractor tenant bootstrap, so a customer portal account is not turned into a contractor owner account just because it authenticated.
