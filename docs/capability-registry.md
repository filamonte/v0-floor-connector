...
and merge evidence exists. Batch 1 approves `assessment-package-depth-v1` and
`area-space-model-v1` for branch/worktree creation only. It does not approve
schemas, migrations, PRs, provider behavior, implementation, or merge.
