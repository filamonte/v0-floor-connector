...
| Feature Coverage          | Future product coverage and owner decisions; not implementation proof. | `contractor-foreman-gap-decision-list.md`, `future-feature-coverage-map.md`                                 |
...
- Feature coverage docs must not claim a feature is implemented unless `current-state.md` or a current-truth audit says so.
- Broad future coverage belongs in dedicated coverage docs, not in `current-state.md`.
...
- growing active docs into unbounded phase histories when archive/reference docs would be clearer
...
- focused companion docs for broad feature coverage, audits, and historical context
...
| Feature coverage decision                           | Update `contractor-foreman-gap-decision-list.md` or `future-feature-coverage-map.md`; do not add current-state claims unless implementation changed. |
