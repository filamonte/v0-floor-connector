...
Implementation status as of 2026-05-18: Project Workspace cleanup, schedule token closeout, and manager filter-chip normalization are implemented as presentation-only changes. Broader nav/icon enforcement remains deferred to the dedicated icon-system phase.
