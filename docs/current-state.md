...
- first lightweight internal work-item foundation:
  ...
  - context-rich Work Item assignments are planned in [docs/design/context-rich-work-items-and-assignments.md](C:/FloorConnector/docs/design/context-rich-work-items-and-assignments.md); direct work-item attachments, structured measurements, dedicated work-item comments, richer status lifecycles, vendor/team assignment, field completion evidence, and portal-safe sharing are not implemented yet
