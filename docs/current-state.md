...
- first lightweight internal work-item foundation:
  ...
  - direct work-item photo/file upload, structured measurement tables, dedicated work-item comments, richer status lifecycles, vendor/team assignment, field completion evidence, and portal-safe sharing remain planned in [docs/design/context-rich-work-items-and-assignments.md](C:/FloorConnector/docs/design/context-rich-work-items-and-assignments.md); work-item photos/files still flow through linked Daily Job Logs, Job Notes, and `execution_attachments`
