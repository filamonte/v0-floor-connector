...
- first lightweight internal work-item foundation:
  ...
  - structured measurement tables, dedicated work-item comments, richer status lifecycles, vendor/team assignment, mobile assignee queues, reminders/notifications, and portal-safe sharing remain planned in [docs/design/context-rich-work-items-and-assignments.md](C:/FloorConnector/docs/design/context-rich-work-items-and-assignments.md)
