...
- first Operational Intelligence cue-rule foundation:
  ...
  - project-level overrides, record-level overrides, assignment actions, cue instances, task records, snooze/dismiss/acknowledge state, notification delivery, AI feedback, custom expression rules, and persisted queue selection are not implemented in this pass
