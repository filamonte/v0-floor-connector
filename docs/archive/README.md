...
- `../opportunity-model.md` points to the archived historical opportunity model and current truth docs
- `../opportunity-implementation-plan.md` points to the archived historical rollout plan and current truth docs
