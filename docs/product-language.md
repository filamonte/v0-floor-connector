...
| Customer Next Step     | One customer-safe portal action derived from already shared records.                                                              | Portal project guidance for reviewing estimates, signing contracts, reviewing change orders, paying invoices, or confirming no action is needed. | Contractor-only ProjectPulse, internal blockers, AI recommendations, portal-only records, or new permission behavior. |
| Project Workspace      | The contractor-side project continuity hub over linked commercial, field, customer-access, proof, service, and financial records. | Project detail and project-centered workflow guidance.                                                                                           | A duplicate module, route rename, or new project model.                                                               |
| Portal Customer Window | The customer-safe portal project workspace pattern.                                                                               | Portal project page framing when describing the combined next-step, status, timeline, and shared-document experience.                            | Contractor-only project health, internal blockers, FieldTrail, Proof Center, or provider details.                     |
| Project Status Window  | Customer-safe portal summary of what is shared, what needs attention, and what is current.                                        | Portal Project Workspace status and shared-record summaries.                                                                                     | Contractor-only project health, ProjectPulse, readiness gates, internal blockers, or portal-only records.             |
| Project Timeline       | Customer-safe project activity timeline derived from already shared portal records.                                               | Portal Project Workspace timeline rows.                                                                                                          | Internal communication history, FieldTrail, Proof Center, provider telemetry, or new timeline tables.                 |
| Shared Documents       | Customer-safe list of shared estimate, contract, invoice, and change-order records.                                               | Portal Project Workspace shared-document section.                                                                                                | Stored PDFs, document management, provider sends, portal-only documents, or internal proof records.                   |
...
| Accounting Readiness   | Read-only invoice, payment, tax, retainage, and reconciliation review before accounting export.                                   | `/financials/accounting-readiness`, export-prep rows, tax/retainage snapshots, and payment review language.                                      | QuickBooks/Xero sync, ledgers, journal entries, provider posting, or accounting-file promises.                        |
| Accounting Export Prep | Spreadsheet-ready review output from already loaded Accounting Readiness rows.                                                    | Copy CSV / Download CSV affordances and review-only export copy.                                                                                 | Accounting sync, stored export files, ledgers, journal entries, provider posting, or source financial mutation.       |
...
Use named layers where they reduce repeated explanation: Project Workspace for
the contractor-side continuity hub, ProjectPulse for project health, CrewBoard
for scheduling visibility, FieldTrail for execution history, MessageCenter for
project communication history, CloseoutTrail for closeout readiness, Proof
Center for project proof review, Send Trail for document delivery evidence,
Document Engine for source-record print/export generation, Portal Customer
Window for the customer-safe portal project experience, Reports for
company-level reporting, Financial Control for collections visibility,
