...
export const timeLocationCaptureMethodSchema = z.enum(
  timeLocationCaptureMethods
);

export const timePunchEventInputSchema = z
  .object({
    ...
    serviceTicketId: optionalUuidField(
      "Select a valid service/warranty ticket."
    ),
    ...
    geofenceSnapshot: z
      ...
      .optional()
      .transform((value) => value ?? null),
    supersedesEventId: optionalUuidField(
      "Select a valid punch event to supersede."
    ),
