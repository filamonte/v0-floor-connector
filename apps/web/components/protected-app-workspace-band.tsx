...
export function ProtectedAppWorkspaceBand({
  ...
  return (
    <div className="bg-neutral-900 px-5 py-2.5 text-white sm:px-6">
      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2">
        ...
        <div className="flex items-center justify-end gap-1">
          <UniversalCreateMenu
            buttonLabel="Create"
            buttonClassName="mr-2 h-7 rounded-[4px] border border-orange-500/30 bg-orange-500 px-3 py-1 text-xs font-semibold text-white hover:bg-orange-600"
            panelClassName="mt-3"
          />
          ...
          {pathname !== "/dashboard" ? (
            <span className="hidden text-[11px] text-orange-400 sm:inline">Active</span>
          ) : null}
        </div>
      </div>
    </div>
