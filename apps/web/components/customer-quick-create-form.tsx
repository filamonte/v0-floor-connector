  ...
  return (
    <form action={action} className="space-y-5">
      ...
      <QuickCreateFormShell
        ...
        description="Create the canonical customer account first with just the primary name. Contact details, financial defaults, and notes can be completed in the full customer workspace."
