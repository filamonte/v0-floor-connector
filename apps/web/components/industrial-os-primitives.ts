...
export const industrialPrimaryActionClassName =
  "inline-flex min-h-9 items-center justify-center rounded-[4px] border border-[#005eb8] bg-[#005eb8] px-3 py-2 text-xs font-semibold text-white transition hover:border-[#003d7c] hover:bg-[#003d7c] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#005eb8] focus-visible:ring-offset-2";

export const industrialSecondaryActionClassName =
  "inline-flex min-h-9 items-center justify-center rounded-[4px] border border-[#c7d2e2] bg-white px-3 py-2 text-xs font-semibold text-[#004f9e] transition hover:border-[#005eb8] hover:bg-[#eef6ff] hover:text-[#003d7c] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#005eb8] focus-visible:ring-offset-2";
