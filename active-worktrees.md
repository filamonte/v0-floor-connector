...
| `field-quick-capture-v1`                | `stream/field-quick-capture-v1`                | Fast field capture stream workspace               | Codex/local | Approved / Not Started | 2026-06-07 | 2026-06-07   | Approved for `mobile-field-capture-closeout-v1`; branch/worktree created from the verified current `main` baseline. Future allowed work may improve quick Daily Log visibility, quick field-note capture, blocker/issue capture using existing field notes, photo/file evidence visibility using existing execution attachments, mobile-friendly layout improvements, and what-happened-today capture. Must avoid new daily-log, field-note, attachment, offline, native mobile, schema, and portal behavior.                                                     | Mobile Field Capture Closeout V1           | 1              |
| `closeout-readiness-command-v1`         | `stream/closeout-readiness-command-v1`         | Closeout readiness stream workspace               | Codex/local | Approved / Not Started | 2026-06-07 | 2026-06-07   | Approved for `mobile-field-capture-closeout-v1`; branch/worktree created from the verified current `main` baseline. Future allowed work may improve closeout readiness visibility, missing Daily Log / field-note / photo evidence signals, unresolved blocker signals, project/job completion handoff clarity, and Field/Project links into invoice/billing readiness where appropriate. Must avoid duplicate invoice/closeout/checklist models, accounting replacement, dashboard sprawl, schema changes, and autonomous billing.                               | Mobile Field Capture Closeout V1           | 2              |
| `field-communications-handoff-v1`       | `stream/field-communications-handoff-v1`       | Field-to-office handoff stream workspace          | Codex/local | Approved / Not Started | 2026-06-07 | 2026-06-07   | Approved for `mobile-field-capture-closeout-v1`; branch/worktree created from the verified current `main` baseline. Future allowed work may improve field-note/blocker links to Communications context, office attention signals from field execution, compact handoff evidence, communication-safe escalation paths, and clearer boundaries between Field evidence and Communications action. Must avoid duplicate communications models, autonomous sends, AI-generated customer sends, portal-only communication copies, schema changes, and dashboard sprawl. | Mobile Field Capture Closeout V1           | 3              |
| `verification-mobile-field-closeout-v1` | `stream/verification-mobile-field-closeout-v1` | Mobile field closeout verification workspace      | Codex/local | Approved / Not Started | 2026-06-07 | 2026-06-07   | Approved for `mobile-field-capture-closeout-v1`; branch/worktree created from the verified current `main` baseline. Owns verification for canonical Daily Logs, field notes, execution attachments, jobs/schedule, no duplicate closeout/issue/punch-list models, no dashboard sprawl, ownership boundaries, portal safety, and no schema/migration drift. Verification must run last after implementation stream commits exist and must avoid feature work, UI redesign, schema changes, migrations, and loosening tests.                                        | Mobile Field Capture Closeout V1           | 4              |
