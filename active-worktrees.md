...
| `field-handoff-packet-v1`             | `stream/field-handoff-packet-v1`             | Field handoff context stream workspace            | Codex/local | Approved / Not Started | 2026-06-06 | 2026-06-06   | Jeff approved `field-execution-depth-v1`; worktree created from current `main` at `9bad7a65`. Owns field handoff context so scheduled jobs arrive with complete execution context. Must avoid duplicate schedule/job models, portal work, dispatch automation, and implementation before a later start command.                                                                                     | Field Execution Depth V1                   | 1              |
| `daily-execution-command-v1`          | `stream/daily-execution-command-v1`          | Daily execution command stream workspace          | Codex/local | Approved / Not Started | 2026-06-06 | 2026-06-06   | Jeff approved `field-execution-depth-v1`; worktree created from current `main` at `9bad7a65`. Owns daily execution workflow over canonical Daily Logs, field notes, blockers, observations, photos, and execution next actions. Must avoid a separate field reporting system, duplicate issue tracker, duplicate punch-list model, schema changes, and implementation before a later start command. | Field Execution Depth V1                   | 2              |
| `crew-execution-visibility-v1`        | `stream/crew-execution-visibility-v1`        | Crew execution visibility stream workspace        | Codex/local | Approved / Not Started | 2026-06-06 | 2026-06-06   | Jeff approved `field-execution-depth-v1`; worktree created from current `main` at `9bad7a65`. Owns cross-project field visibility into active, blocked, incomplete, office-attention, and execution-warning work. Must avoid route optimization, dispatch replacement, crew scheduling replacement, dashboard sprawl, and implementation before a later start command.                              | Field Execution Depth V1                   | 3              |
| `verification-field-execution-v1`     | `stream/verification-field-execution-v1`     | Field execution verification stream workspace     | Codex/local | Approved / Not Started | 2026-06-06 | 2026-06-06   | Jeff approved `field-execution-depth-v1`; worktree created from current `main` at `9bad7a65`. Owns verification of canonical project chain, jobs, schedule, Daily Logs, field notes, and operational ownership. Must avoid feature work, schema changes, UI redesign, loosening checks, and implementation before the feature streams complete.                                                     | Field Execution Depth V1                   | 4              |
