...
| `field-quick-capture-v1`                | `stream/field-quick-capture-v1`                | Fast field capture stream workspace               | Codex/local | Merged                 | 2026-06-07 | 2026-06-07   | Merged to `main` as `d2e9e727`; worktree and branch retained pending explicit retirement approval. Scope improved quick Daily Log visibility, quick field-note capture, blocker/issue capture using existing field notes, photo/file evidence visibility using existing execution attachments, mobile-friendly layout, and what-happened-today capture while avoiding new daily-log, field-note, attachment, offline, native mobile, schema, and portal behavior.                                                                  | Mobile Field Capture Closeout V1           | merged         |
| `closeout-readiness-command-v1`         | `stream/closeout-readiness-command-v1`         | Closeout readiness stream workspace               | Codex/local | Merged                 | 2026-06-07 | 2026-06-07   | Merged to `main` as `cea565d7`; worktree and branch retained pending explicit retirement approval. Scope improved closeout readiness visibility, missing Daily Log / field-note / photo evidence signals, unresolved blocker signals, project/job completion handoff clarity, and Field/Project links into invoice/billing readiness where appropriate while avoiding duplicate invoice/closeout/checklist models, accounting replacement, dashboard sprawl, schema changes, and autonomous billing.                               | Mobile Field Capture Closeout V1           | merged         |
| `field-communications-handoff-v1`       | `stream/field-communications-handoff-v1`       | Field-to-office handoff stream workspace          | Codex/local | Merged                 | 2026-06-07 | 2026-06-07   | Merged to `main` as `c18a8708`; worktree and branch retained pending explicit retirement approval. Scope improved field-note/blocker links to Communications context, office attention signals from field execution, compact handoff evidence, communication-safe escalation paths, and clearer boundaries between Field evidence and Communications action while avoiding duplicate communications models, autonomous sends, AI-generated customer sends, portal-only communication copies, schema changes, and dashboard sprawl. | Mobile Field Capture Closeout V1           | merged         |
| `verification-mobile-field-closeout-v1` | `stream/verification-mobile-field-closeout-v1` | Mobile field closeout verification workspace      | Codex/local | Merged                 | 2026-06-07 | 2026-06-07   | Merged to `main` as `916eb8be`; worktree and branch retained pending explicit retirement approval. Scope added verification for canonical Daily Logs, field notes, execution attachments, jobs/schedule, no duplicate closeout/issue/punch-list models, no dashboard sprawl, ownership boundaries, portal safety, and no schema/migration drift while avoiding feature work, UI redesign, schema changes, migrations, and loosening tests.                                                                                         | Mobile Field Capture Closeout V1           | merged         |
